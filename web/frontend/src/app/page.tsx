...
const FEATURED_LINKS = [
    {
        ...
        href: "/backtesting",
        icon: Activity,
        description: "Backtest 13 trading strategies on historical data",
    ...
    },
    {
        ...
        icon: Shuffle,
        description:
            "Single-asset and multi-asset scenario analysis with percentile fan charts",
    ...
    },
    {
        ...
        icon: LineChart,
        description:
            "Compare leveraged funds and bond ladders with interactive overlays",
    ...
    },
    {
        ...
        icon: Heart,
        description:
            "Model intervention value with QALY and cost-effectiveness analysis",
...
const MORE_LINKS = [
    {
        ...
        icon: TrendingUp,
        description:
            "Run DCA grids, Pareto sweeps, and efficient frontier research",
    ...
    },
    {
        ...
        href: "/risk-analytics",
        icon: Shield,
        description: "VaR, stress testing, and Kelly criterion",
    ...
    },
    {
        ...
        icon: PieChart,
        description: "Rolling metrics, benchmark, drawdown",
        color: "from-sky-500/10 to-sky-600/5",
        iconColor: "text-sky-400",
    },
    {
        label: "Factor Analytics",
        href: "/factor-analytics",
        icon: Layers,
        description: "Multi-factor regression and attribution",
        color: "from-violet-500/10 to-violet-600/5",
        iconColor: "text-violet-400",
    },
    {
        label: "Real-Time Quotes",
        href: "/realtime-quotes",
        icon: Zap,
        description: "Live pricing from multiple providers",
    ...
    },
    {
        ...
        href: "/experiments",
        icon: FlaskConical,
        description: "Compare backtest runs",
        ...
        <Link href={link.href}>
            <div className="group relative h-full overflow-hidden rounded-xl border border-border/50 bg-card/50 p-5 transition-all duration-300 hover:border-border hover:bg-card/80 gradient-border">
                ...
                <div className="relative">
                    ...
                    <h3
                        className={`mt-3 font-semibold ${large ? "text-base" : "text-sm"}`}
                    >
                        {link.label}
                    </h3>
        ...
        <div className="space-y-10">
            ...
            <div className="relative">
                ...
                <div>
                    ...
                    <p className="mt-2 max-w-lg text-sm text-muted-foreground">
                        Quantitative research platform for financial analysis
                        and health economics. Explore strategies, run
                        simulations, and compare intervention value in one
                        workspace.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <StatCard
                    ...
                    value={freshRate}
                    trend={
                        dataStatus && dataStatus.stale_count === 0
                            ? "up"
                            : "down"
                    }
                ...
                <div className="rounded-xl border border-border/50 bg-card/50 p-5">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {dataStatus.sources.map((s) => (
                            ...
                            >
                                <span
                                    className={`mr-1.5 inline-block h-1.5 w-1.5 rounded-full ${s.is_stale ? "bg-red-400" : "bg-emerald-400"}`}
                                />
                                {s.name}: {s.age_str}
                            </Badge>
                        ))}
